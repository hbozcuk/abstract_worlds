# -*- coding: utf-8 -*-
"""
Streamlit app – compares abstract "inner" & "outer" world images using a lightweight remote inference.
"""

# 0) Monkey-patch asyncio.get_running_loop (fixes Streamlit watcher issues on Python 3.13)
import asyncio
...
def compute_metrics(arr: np.ndarray):
    """Compute brightness, contrast, colorfulness and detail metrics"""
