...
# 0) Monkey-patch asyncio.get_running_loop (fixes Streamlit watcher bug on Python 3.13)
import asyncio
...
if st.button("🎨 Oluştur ve Karşılaştır"):
    ...
    # Lazy import & client init inside button
    ...
    ax.plot(angles, m1_plot, 'o-', label='İç Dünya'); ax.fill(angles, m1_plot, alpha=0.25)
    ax.plot(angles, m2_plot, 'o-', label='Dış Dünya'); ax.fill(angles, m2_plot, alpha=0.25)
